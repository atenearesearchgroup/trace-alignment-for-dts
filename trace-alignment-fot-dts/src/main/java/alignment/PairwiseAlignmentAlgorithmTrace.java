...
public abstract class PairwiseAlignmentAlgorithmTrace
{
	 ...
	 * @see #useMatchTag
	 */
	protected static final String MATCH_CHARACTER = "|";
	 ...
	 */
	protected static final String GAP_CHARACTER = "-";
	 ...
	 */
	protected ScoringSchemeTrace scoring;
	 ...
	 */
	public void setScoringScheme (ScoringSchemeTrace scoring)
	{
		if (scoring == null)
	 ...
	 */
	public void loadSequences (Trace input1, Trace input2)
	 ...
	 * @see #loadSequences
	 */
	protected abstract void loadSequencesInternal (Trace input1, Trace input2)
		throws IOException, InvalidSequenceException;
